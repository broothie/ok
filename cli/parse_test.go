...
func TestArgParser_Parse(t *testing.T) {
	...
	flagCasesBuilder := func() map[string]FlagCase {
		return map[string]FlagCase{
			"string long": {
				flag:          &Flag{Name: "flag-a", Type: FlagTypeString},
				tokens:        []string{"--flag-a", "flag-a-value"},
				expectedValue: "flag-a-value",
			},
			"string alias": {
				flag:          &Flag{Name: "flag-b", Type: FlagTypeString, Aliases: []string{"flag-b-alias"}},
				tokens:        []string{"--flag-b-alias", "flag-b-value"},
				expectedValue: "flag-b-value",
			},
			"string short": {
				flag:          &Flag{Name: "flag-c", Type: FlagTypeString, Shorts: []rune{'c'}},
				tokens:        []string{"-c", "flag-c-value"},
				expectedValue: "flag-c-value",
			},
			"string long equals": {
				flag:          &Flag{Name: "flag-d", Type: FlagTypeString},
				tokens:        []string{"--flag-d=flag-d-value"},
				expectedValue: "flag-d-value",
			},
			"string alias equals": {
				flag:          &Flag{Name: "flag-e", Type: FlagTypeString, Aliases: []string{"flag-e-alias"}},
				tokens:        []string{"--flag-e-alias=flag-e-value"},
				expectedValue: "flag-e-value",
			},
			"string short equals": {
				flag:          &Flag{Name: "flag-f", Type: FlagTypeString, Shorts: []rune{'f'}},
				tokens:        []string{"-f=flag-f-value"},
				expectedValue: "flag-f-value",
			},
			"bool long": {
				flag:          &Flag{Name: "flag-g", Type: FlagTypeBool},
				tokens:        []string{"--flag-g"},
				expectedValue: true,
			},
			"bool alias": {
				flag:          &Flag{Name: "flag-h", Type: FlagTypeBool, Aliases: []string{"flag-h-alias"}},
				tokens:        []string{"--flag-h-alias"},
				expectedValue: true,
			},
			"bool short": {
				flag:          &Flag{Name: "flag-i", Type: FlagTypeBool, Shorts: []rune{'i'}},
				tokens:        []string{"-i"},
				expectedValue: true,
			},
			"bool long equals false": {
				flag:          &Flag{Name: "flag-j", Type: FlagTypeBool},
				tokens:        []string{"--flag-j=false"},
				expectedValue: false,
			},
			"bool long equals true": {
				flag:          &Flag{Name: "flag-k", Type: FlagTypeBool},
				tokens:        []string{"--flag-k=true"},
				expectedValue: true,
			},
			"bool alias equals false": {
				flag:          &Flag{Name: "flag-l", Type: FlagTypeBool, Aliases: []string{"flag-l-alias"}},
				tokens:        []string{"--flag-l-alias=0"},
				expectedValue: false,
			},
			"bool alias equals true": {
				flag:          &Flag{Name: "flag-m", Type: FlagTypeBool, Aliases: []string{"flag-m-alias"}},
				tokens:        []string{"--flag-m-alias=1"},
				expectedValue: true,
			},
			"bool short equals false": {
				flag:          &Flag{Name: "flag-n", Type: FlagTypeBool, Shorts: []rune{'n'}},
				tokens:        []string{"-n=f"},
				expectedValue: false,
			},
			"bool short equals true": {
				flag:          &Flag{Name: "flag-o", Type: FlagTypeBool, Shorts: []rune{'o'}},
